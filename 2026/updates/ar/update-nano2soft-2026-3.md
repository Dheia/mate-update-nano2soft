...
تم تنفيذ حزمة تطويرية تهدف إلى تمكين التحكم الكامل في إعدادات إضافة `Nano2\VerifyCode` من خلال واجهة إدارة OctoberCMS، بدلاً من الاعتماد على ملف `config.php` فقط. يتيح هذا التحديث للمطورين ومسؤولي النظام تعديل إعدادات OTP (مدة الصلاحية، قنوات الإرسال، وضع الاختبار، إعدادات الواجهة الأمامية ولوحة التحكم) بسهولة ومرونة، مع إمكانية تخصيص إعدادات مختلفة لكل نوع من عمليات التحقق (الجوال، تسجيل الدخول، البريد الإلكتروني) ولكل من الواجهة الأمامية ولوحة التحكم.
...
من قائمة الإعدادات في OctoberCMS، تظهر فئة جديدة باسم "إدارة التحقق من الرموز (OTP)"، وبداخلها رابط "إعدادات التحقق". عند النقر، تظهر واجهة تحتوي على جميع الإعدادات منظمة في تبويبات.
