...
يحتوي هذا المستند على أمثلة حقيقية ومباشرة لاستخدام جميع نقاط النهاية الخاصة بإدارة **مكتبة الوسائط** (الصور، الفيديوهات، الملفات) عبر API. جميع البيانات التالية مستخرجة من استجابات فعلية للنظام، مع الحفاظ على الدقة والتنسيق الأصلي.
...
نقطة النهاية: `/api/v1/media/categories`
...
**الاستجابة** (مقتطف – التصنيف 2 يحتوي على ألبوم، التصنيف 3 يحتوي على قائمة تشغيل، التصنيف 5 يحتوي على حزمة ملفات)
...
**الاستجابة** (يظهر تصنيفان فقط، والثاني يحتوي على ألبوم)
...
نقطة النهاية: `/api/v1/media/albums`
...
**الاستجابة** (نفس البيانات لكن بدون `created_at` و `updated_at`)
  ...
  "data": [
    {
      ...
      "name": "البوم الصور الاول",
      ...
      // لا يحتوي على created_at و updated_at
    }
  ]
}
```
...
نقطة النهاية: `/api/v1/media/images`
...
**الاستجابة** (مقتطف – الصورة الأولى مع الألبوم المرتبط)
...
**الاستجابة** (مقتطف – الصورة الأولى مع التصنيف)
...
### 3.4 عرض صورة واحدة (`/images/{id}`) مع تضمين الوسوم والألبوم
...
نقطة النهاية: `/api/v1/media/playlists`
...
**الاستجابة** (قائمة التشغيل تحتوي على فيديو واحد)
...
نقطة النهاية: `/api/v1/media/videos`
...
نقطة النهاية: `/api/v1/media/filelists`
...
### 6.4 عرض حزمة ملفات واحدة (`/filelists/{id}`)
...
نقطة النهاية: `/api/v1/media/files`
